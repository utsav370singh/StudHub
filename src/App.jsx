...
const NAV_OFFSET = 80; // sticky navbar height + spacing
...
const App = () => {
  ...
  // Smooth scroll helper (works with Lenis, falls back to native)
  const scrollToSection = useCallback((id) => {
    ...
    if (lenis && typeof lenis.scrollTo === 'function') {
      // Lenis scrollTo supports offset/duration/lerp/etc. :contentReference[oaicite:3]{index=3}
    ...
    const checkDevice = () => {
      ...
      if (viewport && !mobile) {
        viewport.setAttribute(
          'content',
          'width=1200, initial-scale=0.5, maximum-scale=2.0, user-scalable=yes'
        );
      }
    };
  ...
  // ✅ Lenis: butter-smooth scrolling (best for your one-page site)
  useEffect(() => {
    // Avoid double-easing with CSS smooth scroll when Lenis is active
    document.documentElement.style.scrollBehavior = 'auto';
    document.documentElement.style.scrollPaddingTop = `${NAV_OFFSET}px`;

    const lenis = new Lenis({
      // “Best default” feel for portfolio sites
      lerp: isMobile ? 0.10 : 0.075,
      smoothWheel: true,
      smoothTouch: true,
      wheelMultiplier: 1,
    ...
    // If user opens a URL like /#projects, smoothly go there
  ...
  const initParticles = useCallback(() => {
    ...
    const init = () => {
      resizeCanvas();
      createParticles();
      setTimeout(() => animate(), isMobile ? 100 : 50);
    };
    ...
    const handleMouseMove = (e) => {
      ...
      if (particleMoved) animationFrameRef.current = requestAnimationFrame(animate);
    };
  ...
  const servicesData = [
    { icon: FaCode, title: "Web Development", description: "Responsive websites and web applications tailored for students and college projects." },
    { icon: FaMobile, title: "Mobile Apps", description: "Cross-platform mobile applications using React Native for iOS and Android." },
    { icon: FaPalette, title: "UI/UX Design", description: "Beautiful and intuitive designs that enhance user experience and engagement." },
    { icon: FaRocket, title: "Project Deployment", description: "Complete deployment solutions with domain setup and hosting configuration." }
  ];

  const sendEmail = (e) => {
    e.preventDefault();
    emailjs
      .sendForm('service_pnr5uok', 'template_smpcie9', form.current, 'she8kcUPDszRB7iPb')
      .then(() => {
        setIsSubmitted(true);
        form.current.reset();
  ...
  useEffect(() => {
    preloadImages(projectsData.map((p) => p.image));
  }, []);
      ...
      <div className="relative z-10">
            ...
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center space-x-2">
                <img
                  ...
                  loading="lazy"
                  onError={(e) => { e.target.src = "https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80"; }}
                />
              </div>
              ...
              <div className="hidden md:flex items-center space-x-8">
                {['home', 'services', 'projects', 'technologies', 'about', 'contact'].map((item) => (
                  <a
                    ...
                    className={`font-medium transition-all duration-300 ${activeSection === item
                ...
                <div className="flex flex-col space-y-4">
                  {['home', 'services', 'projects', 'technologies', 'about', 'contact'].map((item) => (
                    <a
                      key={item}
                      href={`#${item}`}
                      onClick={(e) => { e.preventDefault(); scrollToSection(item); setIsMenuOpen(false); }}
                      className={`font-medium px-4 py-2 rounded-lg transition-all ${activeSection === item
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <a
                    ...
                    className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-3 rounded-full font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300 text-center backdrop-blur-sm"
                  >
                    View Projects
                  </a>
                  <a
                    ...
                    className="border-2 border-blue-600 text-blue-600 dark:text-blue-400 dark:border-blue-400 px-8 py-3 rounded-full font-semibold hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-300 text-center backdrop-blur-sm"
                  >
                    Get Free Quote
                  </a>
                </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {servicesData.map((service, index) => (
                <div key={index} className="group bg-white/10 dark:bg-gray-800/80 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-2 backdrop-blur-sm border border-white/20">
                  ...
                  <h3 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white mb-2">{service.title}</h3>
              ...
              {projectsData.map((project) => (
                <div key={project.id} className="group bg-white/10 dark:bg-gray-800/80 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden backdrop-blur-sm border border-white/20">
                  ...
                  <div className="p-4 md:p-6">
                    <h3 className="text-lg md:text-xl font-bold text-gray-900 dark:text-white mb-3">{project.title}</h3>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4 md:gap-6">
              {technologiesData.map((tech, index) => (
                ...
                >
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2 text-sm md:text-base">{tech.name}</h3>
                  ...
                  <span className="text-xs md:text-sm text-gray-600 dark:text-gray-300 mt-1 block">{tech.level}%</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="about" className="py-16 relative">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">About StudHub</h2>
              ...
              <div className="relative mt-8 lg:mt-0">
                <div className="bg-white/10 dark:bg-gray-800/80 rounded-2xl p-6 md:p-8 shadow-xl backdrop-blur-sm border border-white/20">
                  <img
                    ...
                    loading="lazy"
                    onError={(e) => { e.target.src = "https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"; }}
                  />
                  <div className="mt-4 md:mt-6 text-center">
                    <h3 className="text-lg md:text-xl font-bold text-gray-900 dark:text-white mb-2">Let's Work Together!</h3>
                    <p className="text-gray-600 dark:text-gray-300 text-sm md:text-base">Get your project started today with a free consultation</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section id="contact" className="py-16 relative">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="max-w-2xl mx-auto bg-white/10 dark:bg-gray-700/80 rounded-2xl p-8 shadow-lg backdrop-blur-sm border border-white/20">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 text-center">Send a Direct Message</h3>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid md:grid-cols-4 gap-6 md:gap-8 mb-6 md:mb-8">
              <div>
                ...
                <p className="text-gray-400 text-sm md:text-base">Creating affordable digital solutions for students worldwide.</p>
              </div>
